...
const CarpenterPricing = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Pricing | Carpenter Service</title>{" "}
        {/* Moved Helmet to CarpenterPricing */}
      </Helmet>
...
export default CarpenterPricing;
