...
const PainterPricing = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Pricing | Painter Service</title>{" "}
        {/* Moved Helmet to PainterPricing */}
      </Helmet>
